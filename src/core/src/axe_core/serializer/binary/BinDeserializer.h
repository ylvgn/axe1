...
//----------
	AXE_INLINE void io_fixed(i8 & value)	{ _io_fixed_le(value); }
	AXE_INLINE void io_fixed(i16& value)	{ _io_fixed_le(value); }
	AXE_INLINE void io_fixed(i32& value)	{ _io_fixed_le(value); }
	AXE_INLINE void io_fixed(i64& value)	{ _io_fixed_le(value); }

	AXE_INLINE void io_fixed(u8 & value)	{ _io_fixed_le(value); }
	AXE_INLINE void io_fixed(u16& value)	{ _io_fixed_le(value); }
	AXE_INLINE void io_fixed(u32& value)	{ _io_fixed_le(value); }
	AXE_INLINE void io_fixed(u64& value)	{ _io_fixed_le(value); }

	AXE_INLINE void io_fixed(f32& value)	{ _io_fixed_le(value); }
	AXE_INLINE void io_fixed(f64& value)	{ _io_fixed_le(value); }
//-----
	AXE_INLINE void io_fixed_le(i8 & value)	{ _io_fixed_le(value); }
	AXE_INLINE void io_fixed_le(i16& value)	{ _io_fixed_le(value); }
	AXE_INLINE void io_fixed_le(i32& value)	{ _io_fixed_le(value); }
	AXE_INLINE void io_fixed_le(i64& value)	{ _io_fixed_le(value); }
	AXE_INLINE void io_fixed_le(u8 & value)	{ _io_fixed_le(value); }
	AXE_INLINE void io_fixed_le(u16& value)	{ _io_fixed_le(value); }
	AXE_INLINE void io_fixed_le(u32& value)	{ _io_fixed_le(value); }
	AXE_INLINE void io_fixed_le(u64& value)	{ _io_fixed_le(value); }

	AXE_INLINE void io_fixed_le(f32& value)	{ _io_fixed_le(value); }
	AXE_INLINE void io_fixed_le(f64& value)	{ _io_fixed_le(value); }
//-----
	AXE_INLINE void io_fixed_be(i8 & value)	{ _io_fixed_be(value); }
	AXE_INLINE void io_fixed_be(i16& value)	{ _io_fixed_be(value); }
	AXE_INLINE void io_fixed_be(i32& value)	{ _io_fixed_be(value); }
	AXE_INLINE void io_fixed_be(i64& value)	{ _io_fixed_be(value); }

	AXE_INLINE void io_fixed_be(u8 & value)	{ _io_fixed_be(value); }
	AXE_INLINE void io_fixed_be(u16& value)	{ _io_fixed_be(value); }
	AXE_INLINE void io_fixed_be(u32& value)	{ _io_fixed_be(value); }
	AXE_INLINE void io_fixed_be(u64& value)	{ _io_fixed_be(value); }

	AXE_INLINE void io_fixed_be(f32& value)	{ _io_fixed_be(value); }
	AXE_INLINE void io_fixed_be(f64& value)	{ _io_fixed_be(value); }
//-----
	...
	AXE_INLINE const u8* cur() const { return _cur; }
	AXE_INLINE size_t remain() const { return _end - _cur; }
	AXE_INLINE const u8* advance(size_t n);
...
private:
	template<class T> AXE_INLINE void _io_fixed_le(T& value);
	template<class T> AXE_INLINE void _io_fixed_be(T& value);
