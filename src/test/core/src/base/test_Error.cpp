...
public:
	void test_AXE_THROW() {
		AXE_TEST_CALL_TREATED_AS_SUCC( AXE_TEST_NOEXCEPT_CALL(AXE_THROW_ERROR("")) );
		AXE_TEST_CALL_TREATED_AS_SUCC( AXE_TEST_NOEXCEPT_CALL(AXE_THROW_ERROR("unsupported")) );
		AXE_TEST_CALL_TREATED_AS_SUCC( AXE_TEST_NOEXCEPT_CALL(AXE_THROW_ERROR("{}", 123)) );
